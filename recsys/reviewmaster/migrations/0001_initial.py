# Generated by Django 5.0.4 on 2024-06-12 02:30
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='Business',
            fields=[
                ('string_id', models.CharField(max_length=22, primary_key=True, serialize=False, unique=True)),
                ...
                ('price', models.CharField(choices=[('$$', 'Reasonable'), ('$', 'Cheap'), ('$$$', 'EXpensive'), ('$$$$', 'Luxurious')], max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('string_id', models.CharField(max_length=22, primary_key=True, serialize=False)),
