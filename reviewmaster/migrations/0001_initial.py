# Generated by Django 5.0.4 on 2024-06-24 01:13
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='Business',
            fields=[
                ('int_id', models.IntegerField(max_length=22, primary_key=True, serialize=False, unique=True)),
                ...
                ('price', models.CharField(choices=[('$$', 'Reasonable'), ('$$$', 'EXpensive'), ('$', 'Cheap'), ('$$$$', 'Luxurious')], max_length=10)),
